...
$(document).ready ->
  ...
  #Slideshow
  launch_slider = (stopSlide, stopLoop) ->
    $(".banner").revolution
      delay: 3000
      startwidth: 1040
      startheight: 600
      ...
      stopAtSlide: stopSlide # Stop Timer if Slide "x" has been Reached. If stopAfterLoops set to 0, then it stops already in the first Loop at slide X which defined. -1 means do not stop at any slide. stopAfterLoops has no sinn in this case.
      stopAfterLoops: stopLoop # Stop Timer if All slides has been played "x" times. IT will stop at THe slide which is defined via stopAtSlide:x, if set to -1 slide never stop automatic
